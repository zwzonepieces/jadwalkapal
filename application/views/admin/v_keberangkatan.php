                ...
                <tbody>
                  ...
                  <?php foreach($keberangkatan as $bk) { ?>
                    <tr>
                      ...
                      <td align="center">
                      <?php echo anchor('admin/controllerberangkat/edit/' .$bk->id_keberangkatan, '<div class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></div>') ?>
...
<div class="modal fade" id="ModalEntryJadwal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="<?php echo site_url('berangkat/simpan') ?>" enctype="multipart/form-data">
...
<div class="modal fade" id="ModalUpdateJadwal<?php echo $bk->id_keberangkatan ?>" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="<?php echo site_url('berangkat/ubah') ?>" enctype="multipart/form-data">
        <div class="modal-body">         
...
function validate(a)
{
    ...
    swal({
        ...
        {
            $(location).attr('href','<?php echo base_url('berangkat/hapus/')?>'+id);
        }
    );
}
 </script>
