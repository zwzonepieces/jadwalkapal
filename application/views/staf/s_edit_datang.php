...
<section class="content">
	<?php foreach ($kedatangan as $jad) : ?>
		<form method="post" action=" <?php echo base_url(). 's_datang/ubah' ?> "> 
            <div class="row">   
                <div class="col-md-5">  
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default"><a href="<?php echo site_url('s_datang') ?>"><i class="fa fa-close"></i> Batal</a></button>
