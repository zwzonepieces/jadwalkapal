    ...
    <section class="content">
        <div class="row">
            ...
            <div class="panel-body">
                <form method="get" action="<?php echo base_url('s_laporandetail') ?>">
                     <div class="row">
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                <label>Filter Tanggal</label>
                                    ...
                                    <div>
                                        <input type="text" name="keyword" value="<?= @$_GET['keyword'] ?>" class="form-control keyword" placeholder="Search Kapal" autocomplete="off"> 
                                    </div>   
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="form-group">
                        ...
                        <?php
                            ...
                            echo '<a href="'.base_url('s_laporandetail/').'" class="btn btn-default">RESET</a>';?>
            ...
            <table class="table table-striped table-bordered table-hover" id="datatableJadwal">
                    <thead>
                        <tr>
                            ...
                            <th width="100px"><center>TGL PERUBAHAN</center></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
