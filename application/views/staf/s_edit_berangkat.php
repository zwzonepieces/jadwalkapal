...
<section class="content">
	<?php foreach ($keberangkatan as $bk) : ?>
		<form method="post" action=" <?php echo base_url(). 's_berangkat/ubah' ?> "> 
            <div class="row">   
                <div class="col-md-5">  
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default"><a href="<?php echo site_url('s_berangkat') ?>"><i class="fa fa-close"></i> Batal</a></button>
