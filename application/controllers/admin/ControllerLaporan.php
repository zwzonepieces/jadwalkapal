...
class ControllerLaporan extends CI_Controller {
	...
	public function index(){
        ...
        $data['url_cetak'] = base_url('laporan/'.$url_cetak);
        $data['label'] = $label;
    ...
    public function cetak(){
		...
		$data['kedatangan'] = $kedatangan;
		ob_start();
		$this->load->view('admin/l_print', $data);
	...
	public function index2(){
		...
		$data['keberangkatan']=$keberangkatan;
		$data['kedatangan']=$kedatangan;
        $data['url_cetak'] = base_url('laporandetail/'.$url_cetak);
        $data['label'] = $label;
		$this->load->view('template/v_header');
		$this->load->view('template/v_sidebar');
		$this->load->view('admin/v_laporandetail',$data);
		$this->load->view('template/v_footer');
    }
    ...
    public function cetak2(){
		...
		$data['kedatangan'] = $kedatangan;
		ob_start();
		$this->load->view('admin/ld_print', $data);
		$html = ob_get_contents();
        ob_end_clean();
